...
$FABRIC_BIN_PATH/peer channel fetch config $VOLUME_PATH/channel-artifacts/config_block.pb -o $ORDERER_NAME:7050 -c $CHANNEL_NAME --tls --cafile $ORDERER_CA_TLS_FILE --certfile $CORE_PEER_TLS_CLIENTCERT_FILE --keyfile $CORE_PEER_TLS_CLIENTKEY_FILE --clientauth
