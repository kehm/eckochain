...
docker stop peer0.$ORG_NAME peer1.$ORG_NAME couchdb0.$ORG_NAME couchdb1.$ORG_NAME orderer0.$ORG_NAME orderer1.$ORG_NAME orderer2.$ORG_NAME ca.$ORG_NAME tlsca.$ORG_NAME
docker rm peer0.$ORG_NAME peer1.$ORG_NAME couchdb0.$ORG_NAME couchdb1.$ORG_NAME orderer0.$ORG_NAME orderer1.$ORG_NAME orderer2.$ORG_NAME ca.$ORG_NAME tlsca.$ORG_NAME
...
sudo rm -fr $VOLUME_PATH/production/peer1.$ORG_NAME $VOLUME_PATH/crypto-config/peer1.$ORG_NAME
